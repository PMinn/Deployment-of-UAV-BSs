function [totalDataTransferRatesOfUAVBSs, satisfiedRate] = main(ue_size, rangeOfPosition, r_UAVBS, isCounterClockwise, minDataTransferRateOfUEAcceptable, maxDataTransferRateOfUAVBS)
    % 參數
